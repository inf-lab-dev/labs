...
URL="https://inf-lab.dev/weather/material/lab-weather.zip"

# the name of the zip file that has been downloaded
ZIP_FILE="lab-weather.zip"
...
unzip "$ZIP_FILE" -d lab-weather && rm "$ZIP_FILE"
...
echo -e "${BOLD}   cd lab-weather${RESET}"
echo -e "${BOLD}   code main.py${RESET}"
